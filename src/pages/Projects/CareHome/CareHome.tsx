      ...
      <>
        <Grid paddingTop={'17px'}>
          <Typography sx={normalTextStyle}>
            Будинок турботи «СЕРДЕНЬКО{'\u2764\uFE0F'}», це не гуртожиток для переселенців. У нього
            зовсім інші задачі, вони більші та глибші. Основна задача це інформаційна, психологічна
            та юридична ПІДТРИМКА кризових вагітних, жінок із дітьми, сиріт -вимушено евакуйованих
            із горячих точок. Ми співпрацюємо з місцевими волонтерами, ЦНАП, пологовими будинками.
          </Typography>
        </Grid>
        <Grid paddingTop={'25px'} display={'flex'} flexDirection={'row'} gap={'40px'}>
          ...
          <Grid>
            <Typography sx={normalTextStyle}>
              В «СЕРДЕНЬКО{'\u2764\uFE0F'}» чотири кімнати для тимчасового проживання матусь із
              дітками, але це ТИМЧАСОВЕ проживання. Звернувшись до «СЕРДЕНЬКО{'\u2764\uFE0F'}»,
              вимушені переселенці зможуть отримати :
            </Typography>
