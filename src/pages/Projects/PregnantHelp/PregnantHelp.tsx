...
const PregnantHelp = () => {
  ...
  return (
    <DetailedInformationPageContainer
      name={'Допомога кризовим вагітним'}
      containerType={ContainerTypes.projects}
    >
      <>
        <Typography sx={{ ...normalTextStyle, paddingTop: '20px' }}>
          Якщо ви опинились перед вибором зберегти життя або зробити аборт, зверніться в Громадську
          організацію «ЗБЕРЕЖИ ДИТИНУ», психологи служби консультують жінок, які зіткнулися з
          проблемою незапланованої вагітності.
        </Typography>
        <Typography sx={{ ...normalTextStyle, paddingTop: '10px' }}>
          ...
          дитину, а також багатодітні сім’ї — отримують соціально-побутову, матеріальну, юридичну та
          іншу допомогу.
        </Typography>
        <Typography sx={{ ...normalTextStyle, paddingTop: '10px' }}>
          Якщо у Вас виникне потреба в психологічній підтримці з питань, пов’язаних з незапланованою
          вагітністю, Ви можете зателефонувати на Телефонну лінію з питань незапланованої
          вагітності:{' '}
        ...
        <Typography sx={{ ...normalTextStyle, paddingTop: '10px' }}>
          ...
          зустрінете ту, хто в силу тих чи інших причин обдумує рішення зробити аборт та звертається
          до вас за порадою, ця стаття стане у нагоді. Ми пропонуємо десять питань, які ви можете
          задати близькій вам жінці, якщо ви хочете допомогти їй у важкій ситуації. Отже
        </Typography>
        <Grid display={'flex'} flexDirection={'row'} gap={'55px'} paddingTop={'15px'}>
          ...
          <Grid>
            ...
            <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
              Це питання для жінки, у якої вже є діти. «А чим дитина, яка ще не народилася, для Вас
              відрізняється від тієї, яка народилася?» Додаткове питання на цю тему: «А з першою
              дитиною у Вас все було безхмарно?
            </Typography>
            <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
              Чи доводилося Вам подолати якісь труднощі заради того, щоб вона народилася?».
            </Typography>
            <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
              Як правило, і з попередньою дитиною жінці доводилося долати якісь труднощі, якщо не в
              період вагітності, то вже після народження дитини. Аборт відбувається, якщо дитина є,
              а жінка відмовляється пускати його в своє життя.
            </Typography>
            <Typography sx={{ ...normalTextStyleSemiBold, paddingTop: '15px' }}>
            ...
            <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
              ...
              через яку вона хоче зробити аборт. Вона подумає про себе як про людину і як про жінку.
              Вона взагалі хоче мати дітей? Чим буде наповнене її життя? Відповідаючи на це питання,
              жінка може проговоритися про свої страхи, про відкидання жіночності, про бунт проти
              своєї жіночої ролі і що-небудь ще. Можна буде вислухати її, обговорити якісь важливі
              моменти, можливо, допомогти позбутися від якихось страхів або стереотипів.
            </Typography>
          </Grid>
        </Grid>
        <Box
        ...
        <Grid paddingLeft={'500px'}>
          ...
          <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
            ...
            Це дуже важливе питання, тому що ці обставини потрібно обов’язково з нею обговорити.
            Дати можливість відповісти на це питання розгорнуто, розповісти про проблеми, страхи,
            сумніви, через яких вона задумалася про аборт. Потрібно чуйно і уважно вислухати її,
            адже ці проблеми для неї дійсно серйозні, навіть якщо Вам вони і не здаються такими.
            Можливо, Вашій співбесідниці стане легше просто від того, що Ви її вислухали з
            розумінням.
          </Typography>
          <Typography sx={{ ...normalTextStyleSemiBold, paddingTop: '15px' }}>
          ...
          <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
            ...
            не посадять. Але ось з моральної точки зору як її вчинок буде виглядати для неї ж самої?
            Вагітна жінка може відповісти: «Але я ж можу розпоряджатися своїм тілом!» Тоді можна
            запитати: «А чому Ви впевнені, що це повністю Ваше тіло? Ви впевнені, що саме у цій
            частині Вашого тіла така ж сама стать, як і у решти Вашого тіла? А де Ви бачили частини
            тіла, які були б з іншою групою крові, ніж все інше тіло?».
          </Typography>
        </Grid>
        ...
        <Grid paddingLeft={'500px'}>
          ...
          <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
            ...
            матеріали активно видобовуються, і їх не хочеться втрачати тим людям, які на них роблять
            гроші. І у них є цілком прагматичний інтерес, щоб число абортів не скорочувалася або,
            якщо скорочувалося, то незначно. І далі можна запитати жінку, чи згодна вона таким чином
            бути використаною якимись силами? Організаціями, людьми, які до її життя ніякого
            відношення не мають і яким її доля глибоко байдужа.
          </Typography>
        </Grid>
        <Grid display={'flex'} gap={'30px'} paddingTop={'25px'}>
          <Box
        ...
        <Grid paddingLeft={'500px'}>
          ...
          <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
            Повертаючись до життєвих обставин жінки, можливо, з’ясується, що хтось із родичів дійсно
            проти. Які аргументи вони наводять? Чому вони це роблять? Робили вони самі аборти і як
            вони ставляться до такого кроку? З’ясувавши ці важливі обставини, необхідно допомогти
            жінці боротися з тиском всередині сім’ї і навіть, можливо, з насильством — фізичним,
            емоційним, моральним, матеріальним і т.д.
          </Typography>
          <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
          ...
          <Typography sx={{ ...normalTextStyle, paddingTop: '7px', paddingLeft: '15px' }}>
            ...
            обставинами, які їй заважають зберегти дитину. І якщо у неї в цей момент запитати: «А що
            я можу зробити?», — вона, швидше за все, відповість, що нічого, і що, в загалом, не дуже
            їй ця допомога і потрібна. Коли ж жінка від’єдналася хоча б трохи від своїх життєвих
            обставин, тоді їй можна розповісти про те, як ці обставини можна змінити.
          </Typography>
        </Grid>
      </>
    </DetailedInformationPageContainer>
